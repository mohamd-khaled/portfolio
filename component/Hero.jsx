...
function Hero() {
  return (
    <div className=" w-full h-screen p-[5%] flex justify-center items-center gap-32 bg-center bg-transparent">
      <div className="m-auto bg-transparent">
        ...
        <div className="mt-5 w-fit">
          <a
            ...
            className="mt-2.5 ml-2.5 font-[20px] rounded-3xl py-2.5 px-5 text-white bg-(--text-color) transition-all duration-300 hover:bg-white hover:shadow-[0px_4px_8px_rgba(79, 146, 150, 0.2)] hover:text-(--text-color)"
            download
          >
            Download CV
          </a>
