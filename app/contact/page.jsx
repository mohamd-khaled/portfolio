...
function page() {
    return (
        <div className=" w-fit h-fit m-auto mt-10 p-10 rounded-4xl items-center bg-(--project-bg)/50 flex flex-col justify-center gap-10 bg-center " id="contact">
            ...
            <div className=" grid gap-10 grid-cols-[repeat(auto-fit,minmax(300px,1fr))] ">
                <div className="mail flex items-center justify-center">
                    <img src="imgs/Email.svg" alt="mail" className="mr-2.5" />
                ...
                <div className="social flex justify-center gap-6">
                    ...
                    <a
                        ...
                        className="text-white text-[1.5rem] transition-all duration-300 hover:text-(--active-text)"
                    >
                        <FontAwesomeIcon icon="fa-brands fa-github" className="w-[35px]" />
                    </a>
                </div>
                <div className="phone flex flex-col items-center justify-center gap-5">
                    <a href="+201016474258">
                        <h3 className="text-white transition-all duration-300 hover:text-(--active-text) flex">
                            <img src="imgs/phone.svg" alt="phone" className="mr-1" /> +201559716567
                        </h3>
                    </a>

                    <a href="+201016474258">
                        <h3 className="text-white transition-all duration-300 hover:text-(--active-text) flex">
                            <img src="imgs/phone.svg" alt="phone" className="mr-1" /> +201016474258
                        </h3>
                    </a>
